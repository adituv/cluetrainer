...
name: "Entrana",
  ...
  },
  {
    ...
    animation_ticks: default_teleport_ticks,
    access: [
      {id: "item", type: "item", name: {kind: "item", name: "Assassin's Insight"}, action_name: "Teleport", img: {url: "slayer_tp_relic.png"}}
    ],
    spots: [
      {
        id: "turael_leaguetp",
        target: {"origin": {"x": 2887, "y": 3545, "level": 0}, "size": {"x": 5, "y": 5}, "data": "//8dAQ=="},
        code: "1",
        name: "Turael",
        menu_ticks: 2,
      },
      {
        id: "jacquelyn_leaguetp",
        target: {"origin": {"x": 3218, "y": 3222, "level": 0}, "size": {"x": 5, "y": 5}, "data": "//8/AQ=="},
        code: "2",
        name: "Jacquelyn",
        menu_ticks: 2,
      },
      {
        id: "vannaka_leaguetp",
        target: {"origin": {"x": 3090, "y": 3476, "level": 0}, "size": {"x": 5, "y": 5}, "data": "3n/vAQ=="},
        code: "3",
        name: "Vannaka",
        menu_ticks: 2,
      },
      {
        id: "raptor_leaguetp",
        target: {"origin": {"x": 3289, "y": 3542, "level": 0}, "size": {"x": 5, "y": 5}},
        code: "4",
        name: "The Raptor",
      },
      {
        id: "mazchna_leaguetp",
        target: {"origin": {"x": 3505, "y": 3504, "level": 0}, "size": {"x": 5, "y": 5}},
        code: "5",
        name: "Mazchna",
      },
      {
        id: "chaeldar_leaguetp",
        target: {"origin": {"x": 2442, "y": 4429, "level": 0}, "size": {"x": 5, "y": 5}, "data": "/H9CAA=="},
        code: "6",
        name: "Chaeldar",
      },
      {
        id: "sumona_leaguetp",
        target: {"origin": {"x": 3356, "y": 2991, "level": 0}, "size": {"x": 5, "y": 5}, "data": "5nxjAA=="},
        code: "7",
        name: "Sumona",
      },
      {
        id: "lapalok_leaguetp",
        target: {"origin": {"x": 2867, "y": 2979, "level": 1}, "size": {"x": 3, "y": 5}, "data": "0jc="},
        code: "8",
        name: "Lapalok",
      },
      {
        id: "kuradal_leaguetp",
        target: {"origin": {"x": 1737, "y": 5310, "level": 1}, "size": {"x": 5, "y": 5}, "data": "/v/nAA=="},
        code: "9",
        name: "Kuradal",
      },
      {
        id: "morvran_leaguetp",
        target: {"origin": {"x": 2194, "y": 3327, "level": 1}, "size": {"x": 3, "y": 3}, "data": "TwA="},
        code: "0",
        name: "Morvran",
      },
      {
        id: "laniakea_leaguetp",
        target: {"origin": {"x": 5666, "y": 2136, "level": 0}, "size": {"x": 5, "y": 5}, "data": "///PAQ=="},
        code: "A",
        name: "Laniakea",
      },
      {
        id: "mandrith_leaguetp",
        target: {"origin": {"x": 3049, "y": 3949, "level": 0}, "size": {"x": 5, "y": 5}},
        code: "B",
        name: "Mandrith",
      },
      {
      ...
      {
        id: "devils_snare",
        target: {"origin": {"x": 5599, "y": 2122, "level": 0}, "size": {"x": 1, "y": 1}},
        name: "Devil's snare",
      },
      {
        id: "edimmus",
